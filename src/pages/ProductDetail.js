...
function ProductDetail() {
    ...
    const { product } = location.state || {
        product: {
            ...
            originalPrice: 50000,
            price: 45000,
            img: 'https://dummyimage.com/600x400/dee2e6/6c757d.jpg',
            content: 'This is a sample product description. This product has many great features and is available at an affordable price.'
        }
    };

    const inCart = isInCart(product.itemKey);
